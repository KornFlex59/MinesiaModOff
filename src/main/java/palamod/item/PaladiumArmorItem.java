...
public abstract class PaladiumArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 55, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(PalamodModItems.PALADIUM_INGOT.get())), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("palamod:paladium_cla"))), 3.5f,
					0.15f);
			registerHelper.register(ResourceLocation.parse("palamod:paladium_armor"), armorMaterial);
