...
public abstract class Paladiumarmorcustom6Item extends ArmorItem {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 8);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("palamod:paladium_custom_6"))), 3.5f, 0.15f);
			registerHelper.register(ResourceLocation.parse("palamod:paladiumarmorcustom_6"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public Paladiumarmorcustom6Item(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends Paladiumarmorcustom6Item {
		public Helmet() {
	...
	public static class Chestplate extends Paladiumarmorcustom6Item {
		public Chestplate() {
	...
	public static class Leggings extends Paladiumarmorcustom6Item {
		public Leggings() {
	...
	public static class Boots extends Paladiumarmorcustom6Item {
		public Boots() {
