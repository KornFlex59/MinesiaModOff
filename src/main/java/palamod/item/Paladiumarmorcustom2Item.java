...
public abstract class Paladiumarmorcustom2Item extends ArmorItem {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.BODY, 8);
					...
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("palamod:paladium_c2"))), 3.5f, 0.15f);
			registerHelper.register(ResourceLocation.parse("palamod:paladiumarmorcustom_2"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public Paladiumarmorcustom2Item(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends Paladiumarmorcustom2Item {
		public Helmet() {
	...
	public static class Chestplate extends Paladiumarmorcustom2Item {
		public Chestplate() {
	...
	public static class Leggings extends Paladiumarmorcustom2Item {
		public Leggings() {
	...
	public static class Boots extends Paladiumarmorcustom2Item {
		public Boots() {
