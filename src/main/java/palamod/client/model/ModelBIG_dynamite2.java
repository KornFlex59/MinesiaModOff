...
public class ModelBIG_dynamite2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("palamod", "model_big_dynamite_2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition dyme_r1_r1 = dyme_r1.addOrReplaceChild("dyme_r1_r1", CubeListBuilder.create().texOffs(0, 14).addBox(2.0F, -1.0F, 6.0F, 0.0F, 0.0F, 2.0F, new CubeDeformation(1.0F)),
