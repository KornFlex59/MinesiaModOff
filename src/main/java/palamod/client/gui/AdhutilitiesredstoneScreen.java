...
public class AdhutilitiesredstoneScreen extends AbstractContainerScreen<AdhutilitiesredstoneMenu> {
	private final static HashMap<String, Object> guistate = AdhutilitiesredstoneMenu.guistate;
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adhutilitiesredstone.label_paladium"), 58, 6, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adhutilitiesredstone.label_mode_set"), 29, 74, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adhutilitiesredstone.label_sell_price_120"), 25, 30, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adhutilitiesredstone.label_buy_price_125"), 25, 44, -12829636, false);
	}
	...
	public void init() {
		...
		number_buy = new EditBox(this.font, this.leftPos + 27, this.topPos + 88, 118, 18, Component.translatable("gui.palamod.adhutilitiesredstone.number_buy")) {
			...
			public void insertText(String text) {
				...
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.palamod.adhutilitiesredstone.number_buy").getString());
				else
					setSuggestion(null);
			}
		...
		number_buy.setSuggestion(Component.translatable("gui.palamod.adhutilitiesredstone.number_buy").getString());
		guistate.put("text:number_buy", number_buy);
		this.addWidget(this.number_buy);
		button_buy = Button.builder(Component.translatable("gui.palamod.adhutilitiesredstone.button_buy"), e -> {
			if (true) {
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adhutilitiesredstone.button_sell"), e -> {
			if (true) {
