...
public class AdminshopplantsugarcaneScreen extends AbstractContainerScreen<AdminshopplantsugarcaneMenu> {
	private final static HashMap<String, Object> guistate = AdminshopplantsugarcaneMenu.guistate;
	...
	public void init() {
		...
		number_buy = new EditBox(this.font, this.leftPos + 27, this.topPos + 88, 118, 18, Component.translatable("gui.palamod.adminshopplantsugarcane.number_buy")) {
			...
			public void insertText(String text) {
				...
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.palamod.adminshopplantsugarcane.number_buy").getString());
				else
					setSuggestion(null);
			}
		...
		number_buy.setSuggestion(Component.translatable("gui.palamod.adminshopplantsugarcane.number_buy").getString());
