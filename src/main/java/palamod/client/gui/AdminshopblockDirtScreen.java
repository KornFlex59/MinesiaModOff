...
public class AdminshopblockDirtScreen extends AbstractContainerScreen<AdminshopblockDirtMenu> {
	...
	public void init() {
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopblock_dirt.button_buy"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshopblockDirtButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopblock_dirt.button_sell"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshopblockDirtButtonMessage(1, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 136, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopblockDirtButtonMessage(2, x, y, z));
