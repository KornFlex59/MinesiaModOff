...
public class AnalyserloadingScreen extends AbstractContainerScreen<AnalyserloadingMenu> {
	private final static HashMap<String, Object> guistate = AnalyserloadingMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public AnalyserloadingScreen(AnalyserloadingMenu container, Inventory inventory, Component text) {
