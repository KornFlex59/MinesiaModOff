...
public class Adminshopmobs2leatherScreen extends AbstractContainerScreen<Adminshopmobs2leatherMenu> {
	private final static HashMap<String, Object> guistate = Adminshopmobs2leatherMenu.guistate;
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				AdshoppreviewamountleatherProcedure.execute(world, entity, guistate), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy = new EditBox(this.font, this.leftPos + 27, this.topPos + 88, 118, 18, Component.translatable("gui.palamod.adminshopmobs_2leather.number_buy")) {
			...
			public void insertText(String text) {
				...
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.palamod.adminshopmobs_2leather.number_buy").getString());
				else
					setSuggestion(null);
			}
		...
		number_buy.setSuggestion(Component.translatable("gui.palamod.adminshopmobs_2leather.number_buy").getString());
