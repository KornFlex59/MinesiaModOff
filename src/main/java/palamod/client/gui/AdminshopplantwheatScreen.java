...
public class AdminshopplantwheatScreen extends AbstractContainerScreen<AdminshopplantwheatMenu> {
	private final static HashMap<String, Object> guistate = AdminshopplantwheatMenu.guistate;
	...
	public AdminshopplantwheatScreen(AdminshopplantwheatMenu container, Inventory inventory, Component text) {
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 27, this.topPos + 88, 118, 18, Component.translatable("gui.palamod.adminshopplantwheat.number_buy")) {
			@Override
