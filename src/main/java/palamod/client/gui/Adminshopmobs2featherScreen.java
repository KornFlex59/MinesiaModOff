...
public class Adminshopmobs2featherScreen extends AbstractContainerScreen<Adminshopmobs2featherMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("palamod:textures/screens/adminshopmobs_2feather.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				AdshoppreviewamountfeatherProcedure.execute(world, entity, guistate), 29, 74, -4671036, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adminshopmobs_2feather.label_sell_price_120"), 25, 30, -4671036, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adminshopmobs_2feather.label_buy_price_125"), 24, 44, -4671036, false);
	}
	...
	public void init() {
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopmobs_2feather.button_buy"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Adminshopmobs2featherButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopmobs_2feather.button_sell"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Adminshopmobs2featherButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 153, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new Adminshopmobs2featherButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new Adminshopmobs2featherButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 118, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new Adminshopmobs2featherButtonMessage(4, x, y, z));
