...
public class AdminshopblockGlowstoneScreen extends AbstractContainerScreen<AdminshopblockGlowstoneMenu> {
	private final static HashMap<String, Object> guistate = AdminshopblockGlowstoneMenu.guistate;
	...
	public AdminshopblockGlowstoneScreen(AdminshopblockGlowstoneMenu container, Inventory inventory, Component text) {
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 27, this.topPos + 88, 118, 18, Component.translatable("gui.palamod.adminshopblock_glowstone.number_buy")) {
			@Override
		...
		number_buy.setSuggestion(Component.translatable("gui.palamod.adminshopblock_glowstone.number_buy").getString());
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopblock_glowstone.button_buy"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopblock_glowstone.button_sell"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 153, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(3, x, y, z));
						AdminshopblockGlowstoneButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 118, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(4, x, y, z));
						AdminshopblockGlowstoneButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
