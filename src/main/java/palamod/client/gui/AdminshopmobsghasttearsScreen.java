...
public class AdminshopmobsghasttearsScreen extends AbstractContainerScreen<AdminshopmobsghasttearsMenu> {
	private final static HashMap<String, Object> guistate = AdminshopmobsghasttearsMenu.guistate;
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				AdshoppreviewamountghasttearsProcedure.execute(world, entity, guistate), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy = new EditBox(this.font, this.leftPos + 27, this.topPos + 88, 118, 18, Component.translatable("gui.palamod.adminshopmobsghasttears.number_buy")) {
			...
			public void insertText(String text) {
				...
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.palamod.adminshopmobsghasttears.number_buy").getString());
				else
					setSuggestion(null);
			}
		...
		number_buy.setSuggestion(Component.translatable("gui.palamod.adminshopmobsghasttears.number_buy").getString());
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopmobsghasttears.button_buy"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshopmobsghasttearsButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopmobsghasttears.button_sell"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshopmobsghasttearsButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 152, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopmobsghasttearsButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 133, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopmobsghasttearsButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 116, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopmobsghasttearsButtonMessage(4, x, y, z));
