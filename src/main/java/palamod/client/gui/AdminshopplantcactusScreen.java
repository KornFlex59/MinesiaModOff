...
public class AdminshopplantcactusScreen extends AbstractContainerScreen<AdminshopplantcactusMenu> {
	...
	public AdminshopplantcactusScreen(AdminshopplantcactusMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adminshopplantcactus.label_paladium"), 58, 6, -1, false);
		guiGraphics.drawString(this.font,

				AdshoppreviewamountcactusProcedure.execute(world, entity, guistate), 29, 74, -4671036, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adminshopplantcactus.label_sell_price_120"), 25, 30, -4671036, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adminshopplantcactus.label_buy_price_125"), 25, 44, -4671036, false);
	}
	...
	public void init() {
		...
		number_buy = new EditBox(this.font, this.leftPos + 27, this.topPos + 88, 118, 18, Component.translatable("gui.palamod.adminshopplantcactus.number_buy")) {
			...
			public void insertText(String text) {
				...
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.palamod.adminshopplantcactus.number_buy").getString());
				else
					setSuggestion(null);
			}
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopplantcactus.button_buy"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshopplantcactusButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopplantcactus.button_sell"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshopplantcactusButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 153, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopplantcactusButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 133, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopplantcactusButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 115, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshopplantcactusButtonMessage(4, x, y, z));
