...
public class AdminshopblockNetherrackScreen extends AbstractContainerScreen<AdminshopblockNetherrackMenu> {
	private final static HashMap<String, Object> guistate = AdminshopblockNetherrackMenu.guistate;
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 27, this.topPos + 88, 118, 18, Component.translatable("gui.palamod.adminshopblock_netherrack.number_buy")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.palamod.adminshopblock_netherrack.number_buy").getString());
				else
					setSuggestion(null);
			}
		...
		number_buy.setSuggestion(Component.translatable("gui.palamod.adminshopblock_netherrack.number_buy").getString());
		guistate.put("text:number_buy", number_buy);
		this.addWidget(this.number_buy);
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopblock_netherrack.button_buy"), e -> {
			if (true) {
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopblock_netherrack.button_sell"), e -> {
			if (true) {
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 151, this.topPos + 4, 16, 16,
