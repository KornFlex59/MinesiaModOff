...
public class AdminshoporefindiumScreen extends AbstractContainerScreen<AdminshoporefindiumMenu> {
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 28, this.topPos + 88, 118, 18, Component.translatable("gui.palamod.adminshoporefindium.number_buy")) {
			@Override
		...
		number_buy.setSuggestion(Component.translatable("gui.palamod.adminshoporefindium.number_buy").getString());
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshoporefindium.button_buy"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshoporefindiumButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshoporefindium.button_sell"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new AdminshoporefindiumButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 154, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshoporefindiumButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshoporefindiumButtonMessage(3, x, y, z));
						AdminshoporefindiumButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 119, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new AdminshoporefindiumButtonMessage(4, x, y, z));
						AdminshoporefindiumButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
