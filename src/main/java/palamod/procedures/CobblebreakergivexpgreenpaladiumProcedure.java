...
public class CobblebreakergivexpgreenpaladiumProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Player _player)
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 7));
					...
					try {
						...
						if (25 <= lvl) {
							...
							if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
								...
								main.addProperty("xp_miner", (30 * main.get("multi_exp").getAsDouble() + main.get("xp_miner").getAsDouble()));
							}
							main.addProperty("xpstreak_miner", (30 * main.get("multi_exp").getAsDouble() + main.get("xpstreak_miner").getAsDouble()));
