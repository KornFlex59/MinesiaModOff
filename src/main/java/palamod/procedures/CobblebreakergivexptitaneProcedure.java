					...
					try {
						...
						if (25 <= lvl) {
							...
							if (entity instanceof Player _player && !_player.level().isClientSide())
								_player.displayClientMessage(Component.literal((Component.translatable("palamod.procedure.jobswin1").getString() + "" + (16 * main.get("multi_exp").getAsDouble() + main.get("xpstreak_miner").getAsDouble())
