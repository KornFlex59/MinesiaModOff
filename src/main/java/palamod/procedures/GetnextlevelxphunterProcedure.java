		...
		if (jobs.exists()) {
			{
				try {
					...
					lvl = main.get("lvl_hunter").getAsDouble() + 1;
					if (0 <= main.get("lvl_hunter").getAsDouble() && 9 >= main.get("lvl_hunter").getAsDouble()) {
						output = Math.pow(435.6292733199 * lvl, 1.30951646);
					} else if (10 <= main.get("lvl_hunter").getAsDouble() && 14 >= main.get("lvl_hunter").getAsDouble()) {
						output = Math.pow(171.2616392443 * lvl, 1.7688843774);
					} else if (15 <= main.get("lvl_hunter").getAsDouble() && 19 >= main.get("lvl_hunter").getAsDouble()) {
						output = Math.pow(121.6760052337 * lvl, 1.8976294404);
					} else if (20 <= main.get("lvl_hunter").getAsDouble() && 29 >= main.get("lvl_hunter").getAsDouble()) {
						output = Math.pow(88.4059273476 * lvl, 2.0044827636);
					} else if (30 <= main.get("lvl_hunter").getAsDouble() && 39 >= main.get("lvl_hunter").getAsDouble()) {
						output = Math.pow(67.1551422088 * lvl, 2.0862726528);
					} else if (40 <= main.get("lvl_hunter").getAsDouble() && 49 >= main.get("lvl_hunter").getAsDouble()) {
						output = Math.pow(56.7868999727 * lvl, 2.1320486715);
					} else if (50 <= main.get("lvl_hunter").getAsDouble()) {
