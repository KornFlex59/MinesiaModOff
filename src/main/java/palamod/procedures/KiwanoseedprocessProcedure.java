...
public class KiwanoseedprocessProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == PalamodModBlocks.FERTILZED_DIRT.get() || (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.FARMLAND)
