...
public class CobblebreakergivexpironProcedure {
						...
						if (25 <= lvl) {
							...
							if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
									...
									&& (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == PalamodModItems.XPBOTTLE.get()) {
								{
									...
									final double _tagValue = (2 * main.get("multi_exp").getAsDouble()
								...
								main.addProperty("xp_miner", (2 * main.get("multi_exp").getAsDouble() + main.get("xp_miner").getAsDouble()));
							}
							main.addProperty("xpstreak_miner", (2 * main.get("multi_exp").getAsDouble() + main.get("xpstreak_miner").getAsDouble()));
