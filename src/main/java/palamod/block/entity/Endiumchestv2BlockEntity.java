...
public class Endiumchestv2BlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(26, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public Endiumchestv2BlockEntity(BlockPos position, BlockState state) {
		super(PalamodModBlockEntities.ENDIUM_CHEST.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("endium_chest");
	}
