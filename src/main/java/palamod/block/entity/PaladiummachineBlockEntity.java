...
public class PaladiummachineBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public PaladiummachineBlockEntity(BlockPos position, BlockState state) {
		super(PalamodModBlockEntities.PALADIUM_MACHINE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("paladium_machine");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new PalamachineguiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
