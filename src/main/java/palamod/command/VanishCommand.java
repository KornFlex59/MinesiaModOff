...
import palamod.procedures.VanishonProcedure;
import palamod.procedures.VanishoffProcedure;
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("vanish")
				...
				.then(Commands.literal("off").executes(arguments -> {
					...
					VanishoffProcedure.execute(entity);
					return 0;
					...
					VanishonProcedure.execute(entity);
					return 0;
				})));
	}
}
