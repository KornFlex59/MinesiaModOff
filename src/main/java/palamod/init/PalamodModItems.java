...
public class PalamodModItems {
	...
	public static final DeferredItem<Item> PICKAXE_PATTERN = REGISTRY.register("pickaxe_pattern", PickaxepaternItem::new);
	public static final DeferredItem<Item> BROADSWORD_PATTERN = REGISTRY.register("broadsword_pattern", BroadswordpaternItem::new);
	public static final DeferredItem<Item> BLOCK_PATTERN = REGISTRY.register("block_pattern", BlockpaternItem::new);
	public static final DeferredItem<Item> FASTSWORD_PATTERN = REGISTRY.register("fastsword_pattern", FastswordpaternItem::new);
	public static final DeferredItem<Item> INGOT_PATTERN = REGISTRY.register("ingot_pattern", IngotpaternItem::new);
	public static final DeferredItem<Item> HAMMER_PATTERN = REGISTRY.register("hammer_pattern", HammerpaternItem::new);
	public static final DeferredItem<Item> SWORD_PATTERN = REGISTRY.register("sword_pattern", SwordpaternItem::new);
	public static final DeferredItem<Item> SHOVEL_PATTERN = REGISTRY.register("shovel_pattern", ShovelpaternItem::new);
	...
	public static final DeferredItem<Item> SOCKET_PATTERN = REGISTRY.register("socket_pattern", SocketpaternItem::new);
	...
	public static final DeferredItem<Item> GLUEBALLPATTERN = REGISTRY.register("glueballpattern", GlueballpaternItem::new);
	...
	public static final DeferredItem<Item> ROTATED_PALADIUM_HOPPER = block(PalamodModBlocks.ROTATED_PALADIUM_HOPPER);
