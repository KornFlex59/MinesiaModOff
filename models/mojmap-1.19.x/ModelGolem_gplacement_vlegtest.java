...
public class ModelGolem_gplacement_vlegtest<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "golem_gplacement_vlegtest"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = left_leg.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(37, 0).addBox(-3.0F, -8.0F, -2.5F, 6.0F, 16.0F, 5.0F,
		...
		PartDefinition cube_r2 = right_leg
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(60, 0).addBox(-3.0F, -8.0F, -2.5F, 6.0F, 16.0F, 5.0F,
								new CubeDeformation(0.0F)),
