...
public static class Modelgolem_v2 extends EntityModel<Entity> {
	...
	public Modelgolem_v2() {
		textureWidth = 64;
		textureHeight = 64;

		brasg = new ModelRenderer(this);
		brasg.setRotationPoint(0.0F, 24.0F, 0.0F);
		brasg.setTextureOffset(30, 29).addBox(7.0F, -18.0F, 0.0F, 2.0F, 15.0F, 3.0F, 1.0F, false);
		...
		tete.setTextureOffset(0, 0).addBox(-2.0F, -26.0F, 0.0F, 4.0F, 5.0F, 4.0F, 1.0F, false);
		...
		brasd.setTextureOffset(30, 11).addBox(-9.0F, -18.0F, 0.0F, 2.0F, 15.0F, 3.0F, 1.0F, false);

		jambeg = new ModelRenderer(this);
		jambeg.setRotationPoint(0.0F, 24.0F, 0.0F);
		jambeg.setTextureOffset(18, 0).addBox(1.0F, -8.0F, 0.0F, 3.0F, 7.0F, 3.0F, 1.0F, false);
	}
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
		this.jambeg.rotateAngleZ = MathHelper.cos(f * 1.0F) * 1.0F * f1;
		this.brasd.rotateAngleZ = MathHelper.cos(f * 0.6662F + (float) Math.PI) * f1;
		this.Jambed.rotateAngleZ = MathHelper.cos(f * 1.0F) * 1.0F * f1;
		this.brasg.rotateAngleZ = MathHelper.cos(f * 0.6662F) * f1;
	}
}